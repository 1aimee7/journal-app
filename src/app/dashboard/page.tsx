        ...
        {entries.length === 0 ? (
          <div className="text-center py-12">
            <div className="max-w-sm mx-auto">
              ...
              <button
                onClick={() => router.push('/new-entry')}
                className="inline-flex items-center px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-full hover:bg-gray-800 transition-colors"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h3 className="text-base font-semibold text-gray-900 mb-1 uppercase">{entry.title}</h3>
                    <p className="text-xs text-gray-500 mb-3">{entry.date}</p>
                    <p className="text-sm text-gray-700 leading-relaxed mb-4">{entry.content}</p>
                  </div>
                  <button
